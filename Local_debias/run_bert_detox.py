import numpy as np
from Local_debias.model import LayerBert
...
# layerBert = LayerBERT(base_model, gpu=0)
# layerBert = layerBert.cuda()
# debiaser = Debiaser(ht, wsentTox, tokenizer, [], 1)
# ev_percent, ev = debiaser.run(layerBert)
